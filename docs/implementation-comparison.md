...
|----------------|--------|--------|------------|--------|-----------------|
| Rust | `5b03787` | `689 / 689` | `0` | `0` | `3.01` |
| JS | `8105210` | `689 / 689` | `0` | `0` | `76.02` |
| PHP | `a5f18fb` | `689 / 689` | `0` | `0` | `68.54` |
...
profile=default/no-opt-in corpus=core corpus_pairs=689 targets=html,markdown,plain,carve,ansi
...
html: compared=689 diffs=0 errors=0 fixtures=yes
markdown: compared=689 diffs=0 errors=0 fixtures=1
plain: compared=689 diffs=0 errors=0 fixtures=1
carve: compared=689 diffs=0 errors=0 fixtures=13
ansi: compared=689 diffs=0 errors=0 fixtures=none
