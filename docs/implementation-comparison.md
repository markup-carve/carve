...
|----------------|--------|--------|------------|--------|-----------------|
| Rust | `5b03787` | `731 / 740` | `0` | `0` | `3.01` |
| JS | `8105210` | `731 / 740` | `0` | `0` | `76.02` |
| PHP | `a5f18fb` | `733 / 740` | `0` | `0` | `68.54` |
...
profile=default/no-opt-in corpus=core corpus_pairs=740 targets=html,markdown,plain,carve,ansi
