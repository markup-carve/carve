...
|----------------|--------|--------|------------|--------|-----------------|
| Rust | `5b03787` | `735 / 758` | `0` | `0` | `3.01` |
| JS | `8105210` | `735 / 758` | `0` | `0` | `76.02` |
| PHP | `a5f18fb` | `737 / 758` | `0` | `0` | `68.54` |
...
profile=default/no-opt-in corpus=core corpus_pairs=758 targets=html,markdown,plain,carve,ansi
