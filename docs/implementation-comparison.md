...
|----------------|--------|--------|------------|--------|-----------------|
| Rust | `dcb8236` | `647 / 647` | `0` | `0` | `2.69` |
| JS | `d7eb728` | `647 / 647` | `0` | `0` | `70.21` |
| PHP | `83977e4` | `647 / 647` | `0` | `0` | `62.80` |
...
rust: pass=661/661 mismatch=0 error=0 skipped=0 runs=3235 avg_ms=2.69
  mismatching documents: 0
js: pass=661/661 mismatch=0 error=0 skipped=0 runs=3235 avg_ms=70.21
  mismatching documents: 0
php: pass=661/661 mismatch=0 error=0 skipped=0 runs=3235 avg_ms=62.80
  mismatching documents: 0
cross_impl_diffs=0
