...
| [`CARVE-P11-054`](https://github.com/markup-carve/carve/blob/main/resources/spec/22-writer-targets.ebnf#L170) | 11 | A PIPE IN A TABLE CELL IS ESCAPED |
| [`CARVE-P11-026`](https://github.com/markup-carve/carve/blob/main/resources/spec/22-writer-targets.ebnf#L180) | 11 | THE MARKDOWN TARGET'S HARD BREAK |
| [`CARVE-P11-048`](https://github.com/markup-carve/carve/blob/main/resources/spec/22-writer-targets.ebnf#L196) | 11 | A HARD BREAK IN A TABLE CELL IS `<br>` |
| [`CARVE-P11-027`](https://github.com/markup-carve/carve/blob/main/resources/spec/22-writer-targets.ebnf#L216) | 11 | A LIST ITEM'S CONTINUATION LINES ARE ALIGNED |
| [`CARVE-P11-028`](https://github.com/markup-carve/carve/blob/main/resources/spec/22-writer-targets.ebnf#L228) | 11 | AN UNUSED DEFINITION SURVIVES THE NON-HTML TARGETS |
| [`CARVE-P11-029`](https://github.com/markup-carve/carve/blob/main/resources/spec/22-writer-targets.ebnf#L255) | 11 | A TABLE ROW KEEPS ITS OWN CELL COUNT |
| [`CARVE-P11-030`](https://github.com/markup-carve/carve/blob/main/resources/spec/22-writer-targets.ebnf#L270) | 11 | ADJACENT BLOCKS THAT WOULD MERGE KEEP THE CONTINUATION MARKER |
| [`CARVE-P11-031`](https://github.com/markup-carve/carve/blob/main/resources/spec/22-writer-targets.ebnf#L284) | 11 | MULTIPLE CARVE HEADER ROWS SURVIVE THE MARKDOWN TARGET |
| [`CARVE-P11-032`](https://github.com/markup-carve/carve/blob/main/resources/spec/22-writer-targets.ebnf#L297) | 11 | A PRESENTATION TARGET KEEPS A CAPTION, A FENCE TITLE AND A FENCE LABEL |
| [`CARVE-P11-033`](https://github.com/markup-carve/carve/blob/main/resources/spec/22-writer-targets.ebnf#L363) | 11 | A REFERENCED ABBREVIATION DEFINITION SPLITS BY TARGET |
| [`CARVE-P11-034`](https://github.com/markup-carve/carve/blob/main/resources/spec/22-writer-targets.ebnf#L421) | 11 | A COMPOSITE FIGURE SURVIVES EVERY TARGET |
| [`CARVE-P11-035`](https://github.com/markup-carve/carve/blob/main/resources/spec/22-writer-targets.ebnf#L465) | 11 | THE PLAIN-TEXT TARGET PRESERVES LIST DEPTH |
| [`CARVE-P11-047`](https://github.com/markup-carve/carve/blob/main/resources/spec/22-writer-targets.ebnf#L551) | 11 | THE MARKDOWN TARGET KEEPS A LIST'S TIGHTNESS |
| [`CARVE-P11-055`](https://github.com/markup-carve/carve/blob/main/resources/spec/22-writer-targets.ebnf#L573) | 11 | A PARAGRAPH LINE CARRIES NO EDGE WHITESPACE |
| [`CARVE-P11-056`](https://github.com/markup-carve/carve/blob/main/resources/spec/22-writer-targets.ebnf#L587) | 11 | A TABLE WITHOUT A HEADER ROW GETS AN EMPTY ONE |
| [`CARVE-P11-057`](https://github.com/markup-carve/carve/blob/main/resources/spec/22-writer-targets.ebnf#L604) | 11 | ADJACENT LISTS OF ONE KIND ALTERNATE THEIR MARKER |
| [`CARVE-P11-058`](https://github.com/markup-carve/carve/blob/main/resources/spec/22-writer-targets.ebnf#L621) | 11 | A DEFINITION LIST IS WRITTEN AS ITS TERMS AND BLOCKS |
| [`CARVE-P11-036`](https://github.com/markup-carve/carve/blob/main/resources/spec/22-writer-targets.ebnf#L479) | 11 | A HARD LIST BOUNDARY IS WRITTEN AS EXACTLY THREE BLANK LINES |
| [`CARVE-P11-037`](https://github.com/markup-carve/carve/blob/main/resources/spec/22-writer-targets.ebnf#L504) | 11 | AN UNSPELLABLE BLOCK DOES NOT CANCEL THE ADJACENCY IT CANNOT SPELL |
| [`CARVE-P11-038`](https://github.com/markup-carve/carve/blob/main/resources/spec/22-writer-targets.ebnf#L636) | 11 | THE MARKDOWN TARGET LINKS A HEADING BY ITS GFM SLUG |
| [`CARVE-P11-049`](https://github.com/markup-carve/carve/blob/main/resources/spec/22-writer-targets.ebnf#L686) | 11 | THE MARKDOWN TARGET KEEPS A FRAGMENT LINK |
...
| [`CARVE-P11-043`](https://github.com/markup-carve/carve/blob/main/resources/spec/22-writer-targets.ebnf#L527) | 11 | THE ROUND-TRIP COMPARISON NORMALIZES A NAMED LIST |
