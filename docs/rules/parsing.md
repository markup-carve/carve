...
This view contains 111 of 250 active rules. Every rule remains mandatory where applicable.
...
| [`CARVE-P9-013`](https://github.com/markup-carve/carve/blob/main/resources/spec/14-semantics-blocks.ebnf#L121) | 9 | AN INVISIBLE LINE IS ONE CLASSIFICATION |
| [`CARVE-P9-014`](https://github.com/markup-carve/carve/blob/main/resources/spec/14-semantics-blocks.ebnf#L260) | 9 | N1a HARD BOUNDARY AFTER THREE BLANK LINES |
| [`CARVE-P9-016`](https://github.com/markup-carve/carve/blob/main/resources/spec/14-semantics-blocks.ebnf#L345) | 9 | A COLON-FENCE LINE THAT FAILS THE OPENER TEST LEAVES THE PARAGRAPH EXPECTING A CLOSER |
| [`CARVE-P9-017`](https://github.com/markup-carve/carve/blob/main/resources/spec/14-semantics-blocks.ebnf#L365) | 9 | ABSORPTION REACHES A PARAGRAPH'S OWN LINES ONLY |
| [`CARVE-P9-020`](https://github.com/markup-carve/carve/blob/main/resources/spec/14-semantics-blocks.ebnf#L572) | 9 | INLINE SPAN VS LINK DISAMBIGUATION |
| [`CARVE-P9-021`](https://github.com/markup-carve/carve/blob/main/resources/spec/14-semantics-blocks.ebnf#L593) | 9 | EMPTY OR INVALID ATTRIBUTE BLOCK |
| [`CARVE-P9-022`](https://github.com/markup-carve/carve/blob/main/resources/spec/14-semantics-blocks.ebnf#L616) | 9 | BOOLEAN (value-less) ATTRIBUTES |
| [`CARVE-P9-023`](https://github.com/markup-carve/carve/blob/main/resources/spec/14-semantics-blocks.ebnf#L655) | 9 | A2a AN INVISIBLE CONSTRUCT IS NOT THE NEXT BLOCK |
| [`CARVE-P9-024`](https://github.com/markup-carve/carve/blob/main/resources/spec/14-semantics-blocks.ebnf#L680) | 9 | A4 DROP IF DANGLING |
