...
| [AST interchange](./ast-interchange) | 38 | The core serialized tree shape, source positions, and cross-implementation AST guarantees. |
...
Together the views cover all 257 active rules exactly once. The source metadata lives in `resources/spec/rules.json`.
