...
| [AST interchange](./ast-interchange) | 40 | The core serialized tree shape, source positions, and cross-implementation AST guarantees. |
...
Together the views cover all 259 active rules exactly once. The source metadata lives in `resources/spec/rules.json`.
