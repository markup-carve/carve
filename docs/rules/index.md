...
| [Canonical writing](./canonical-writing) | 44 | Canonical Carve source, Markdown and plain-text targets, round trips, and escaping. |
| [Imports, security, and extensions](./imports-security-extensions) | 25 | Optional and host-facing behavior, importer contracts, security limits, diagnostics, and extension surfaces. |

Together the views cover all 252 active rules exactly once. The source metadata lives in `resources/spec/rules.json`.
