...
| [Canonical writing](./canonical-writing) | 59 | Canonical Carve source, Markdown and plain-text targets, round trips, and escaping. |
...
Together the views cover all 294 active rules exactly once. The source metadata lives in `resources/spec/rules.json`.
