 ...
 */
export function promoteBlockImages(blocks, figuresOnly = false) {
    for (let i = 0; i < blocks.length; i++) {
        ...
        if (b.type === 'paragraph' &&
            ...
            (b.children[0].pos === undefined ||
                b.children[0].pos.startColumn === 1) &&
