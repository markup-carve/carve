...
A mention name runs over letters, digits, `_` and `-`; anything else ends it. Sentence punctuation directly after the name stays literal (and an apostrophe becomes a typographic quote).

::: compare

```carve
Ping @john-doe and @john_doe today.

Reach @john. That is @john's idea, @john!
```

```html
<p>Ping <span class="mention"><strong>@john-doe</strong></span> and <span class="mention"><strong>@john_doe</strong></span> today.</p>
