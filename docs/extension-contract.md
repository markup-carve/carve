---
description: Normative matcher, transform, renderer, configuration, and feature contracts for Carve extension implementers.
---

# Extension contract

This is the technical and normative companion to the reader-facing
[Optional features and extensions](./extensions) guide. Use it when implementing
an extension system or reproducing a standard extension in another engine.
...
[HTML import](./html-import-contract#a-derived-attribute-does-not-come-back)). Keeping it
