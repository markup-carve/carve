...
- The current build is vendored from `@markup-carve/carve` (see [`docs/.vitepress/carve-lib/`](https://github.com/markup-carve/carve/tree/master/docs/.vitepress/carve-lib) in the repo).
