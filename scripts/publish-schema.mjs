...
for (const name of ['ast-schema.json', 'node-roles.json', 'ast-source-layout-schema.json', 'html-import-schema.json', 'importer-fidelity-schema.json', 'migration-report-schema.json', 'render-loss-report.schema.json', 'source-patch.schema.json']) {
