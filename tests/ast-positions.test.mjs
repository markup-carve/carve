 ...
 * the leading run for leaf types. Fourteen corpus documents formerly placed a
 * `comment` one to three codepoints into that run in the pinned carve-js. The
 * pin now includes carve-js#1631, so the closing list is empty again.
 *
