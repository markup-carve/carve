...
const SITES = [
  ...
  },
  {
    ...
    required: /header_cell = '=', \[alignment_run\], \[cell_attributes\], cell_padding, cell_content, \{space\} ;/,
  ...
  },
  {
    ...
    required: /data_cell\s+=\s+\[alignment_run\], \[cell_attributes\], cell_padding, cell_content, \{space\} ;/,
